...
|       | Ir   | 
| ----- | ----- | 
| **Yo**    | <span style={{color: 'red'}}>estoy</span>     | 
| **Tú**    | <span style={{color: 'red'}}>estás</span>    |
| **Él, ella**    | <span style={{color: 'red'}}>está</span>     |
| **Nosotros**    | estamos     | 
| **Vosotros**    | estáis     | 
| **Ellos**    | <span style={{color: 'red'}}>están</span>     | 
...
<div class="custom-quote">  
<p>
***<mark>Me</mark> estoy bañando en el mar.***   
&nbsp;&nbsp;&nbsp;<small>🇸🇪 *Jag badar i havet.*</small>    
***¿Estás duchándo<mark>te</mark> ahora mismo***   
&nbsp;&nbsp;&nbsp;<small>🇸🇪 *Duschar du just nu?*</small>    
***Creen que <mark>os</mark> están relajando.***   
...
<div class="custom-quote">  
<p>
***¿Qué está p<mark>i</mark>diendo?***   
&nbsp;&nbsp;&nbsp;<small>🇸🇪 *Vad beställer han?*</small>    
***Están rep<mark>i</mark>tiendo todo.***   
&nbsp;&nbsp;&nbsp;<small>🇸🇪 *De håller på att upprepa allt.*</small>     
***Me están s<mark>i</mark>rviendo comida rica.***   
&nbsp;&nbsp;&nbsp;<small>🇸🇪 *De serverar mig god mat.*</small>    
***¿Qué estás d<mark>i</mark>ciendo?***   
&nbsp;&nbsp;&nbsp;<small>🇸🇪 *Vad säger du?*</small>
</p>
</div>
...
<div class="custom-quote">  
<p>
***¿<mark>Te está gustando</mark> el calor?***   
&nbsp;&nbsp;&nbsp;<small>🇸🇪 *Gillar du värmen (precis just nu)?*</small>    
***No, <mark>me está encantando</mark> el calor.***   
&nbsp;&nbsp;&nbsp;<small>🇸🇪 *Nej, jag älskar värmen (precis just nu).*</small>   
***<mark>está gustándome</mark> comer.***   
&nbsp;&nbsp;&nbsp;<small>🇸🇪 *Jag gillar att äta (precis just nu).*</small>      
***<mark>Están gustándome</mark> los gatos negros.***   
&nbsp;&nbsp;&nbsp;<small>🇸🇪 *Jag gillar svarta katter (precis just nu).*</small>    
***<mark>Me están interesando</mark> las ciencias sociales.***   
&nbsp;&nbsp;&nbsp;<small>🇸🇪 *Jag är intresserad av SO (precis just nu).*</small>
</p>
</div>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td rowspan="6">ando</td>
      <td rowspan="6">iendo</td>
    </tr>
    <tr>
      <th> Tú</th>
      <td> te</td>
...
| **Yo**           | **me** estoy bañando  | 
| **Tú**           | **te** estás bañando     |
| **Él, ella**     | **se** está bañando    |
| **Nosotros**     | **nos** estamos bañando  |   
| **Vosotros**     | **os** estáis bañando    |
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td> <span style={{color: 'red'}}>estoy</span> </td>
      <td rowspan="6">stam +</td>
      <td rowspan="6">ándo +</td>
      <td rowspan="6">iéndo +</td>
      <td> me</td>
    </tr>
    <tr>
      <th> Tú</th>
...
| **Yo**           | estoy bañándo**me**   | 
| **Tú**           | estás bañándo**te**      |
| **Él, ella**     | está bañándo**se**       |
| **Nosotros**     | estamos bañándo**nos**   |   
| **Vosotros**     | estáis bañándo**os**    |
| **Ellos**        | están bañándo**se**     | 
...
För verb utan dativ finns det två sätt att bilda gerundium. Alternativ 1 är vanligast och rekommenderas, men det är bra att känna till alternativ 2.
...
<table>
  ...
  <tbody>
    <tr>
      <td rowspan="6">está</td>
      <td rowspan="6">están</td>
      <td rowspan="6">gustándo +</td>
      <td>**Me**</td>
    </tr>
    <tr>
      <td>**Te**</td>
